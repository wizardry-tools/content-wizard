import { AEM_GRAPHQL_TYPES } from "./ClientService";
 ...
 */
function objToStringArgs (obj:any):string {
 ...
 */
const __modelByPath = (model:string, fields:string, args:any):any => {
  if (!args || !args._path) {
 ...
 * @returns {QueryBuilderResult}
 */
const __modelList = (model:string, fields:string, args:any = {}):any => {
 ...
 * @returns {QueryBuilderResult}
 */
const __modelPaginated = (model:string, fields:string, args:any = {}):any => {
...
export const getQueryType = (args:any = {}):string => {
  if (args._path) {
 ...
 */
export const graphQLQueryBuilder = (model:string, fields:string, config:any = {}, args:any = {}):any => {
  if (args._path) {
