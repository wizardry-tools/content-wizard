...
describe('DocExplorer', () => {
  it('renders spinner when the schema is loading', () => {
    ...
    const spinner = container.querySelectorAll('.wizard-spinner');
  ...
  it('renders correctly with schema error', () => {
    ...
    const error = container.querySelector('.wizard-doc-explorer-error');
    ...
    const errors = container.querySelectorAll('.wizard-doc-explorer-error');
  ...
  it('maintains nav stack when possible', () => {
    ...
    const [title] = container.querySelectorAll('.wizard-doc-explorer-title');
    ...
    const [title2] = container.querySelectorAll('.wizard-doc-explorer-title');
