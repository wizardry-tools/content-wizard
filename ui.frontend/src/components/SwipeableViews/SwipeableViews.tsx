...
const SwipeableViews = (props: SwipeableViewsProps) => {
  ...
  const indexUpdate = useCallback((i: number) => {
  ...
  const updateActiveSlide = useCallback((node: HTMLDivElement) => {
